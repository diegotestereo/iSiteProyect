package com.iSiteProyect.layouts;

import com.iSiteProyect.Homescreen;
...
public class ll_login extends Activity {
	...
	private TextView TxtReceptor;
	 EditText EditPassLinux,EditPassiSite;
	private Button btn_logiSite,btn_logLinux;
...
protected void onCreate(Bundle savedInstanceState) {
	...
	// LEVANTO LOS VALORES DE LOS EXTRAS
...
private void Botones() {
		btn_logLinux.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				try {
					mBTSocket.getOutputStream().write(("rtr\r").getBytes());
		...
		btn_logiSite.setOnClickListener(new OnClickListener() {
...
private void LevantarXML() {
	...
	btn_logiSite=(Button) findViewById(R.id.btn_logiSite);
	btn_logLinux=(Button) findViewById(R.id.btn_logLinux);
	EditPassLinux=(EditText) findViewById(R.id.EditPassLinux);	
	EditPassiSite=(EditText) findViewById(R.id.EditPassiSite);	
	TxtReceptor=(TextView) findViewById(R.id.TxtReceptor);	
}
/*
			...
			while (!bStop) {
				...
				if (inputStream.available() > 0) {
					 ...
					 */
								...
								detectorString=strInput;
								TxtReceptor.setText(detectorString);
								/// DETECTA STRING
